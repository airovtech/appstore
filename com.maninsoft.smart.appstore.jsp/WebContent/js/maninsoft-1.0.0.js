...
var MisConfig = {
	popupNotification_url: getPath() + "/util/dialog/notification.jsp",
	popupConfirmation_url: getPath() + "/util/dialog/confirmation.jsp",
	popupWarning_url: getPath() + "/util/dialog/warning.jsp"
};
...
var Mis = {
	...
	createModalDialog: function() {
		...
		divStr += " width: 100%; height: 100%; position: absolute; z-index: -1; left: " + left + "px; top: " + top + "px;";
	...
	showModalDialog: function(id) {
		...
		scope.style.left = document.documentElement.offsetWidth/2 - scope.offsetWidth/2 + "px";
