...
<div id="contents_wrap">
	<div id="list_title_area">
		<div id="list_title">
			...
			<a href="javascript:PageUtil.goLeftMenu('<%=typeCatId %>','','<%=curPage %>')"><span class="txlarge2"><%=typeCatName %></span></a>,
			<a href="javascript:PageUtil.goLeftMenu('','<%=catId %>','<%=curPage %>')"><span class="txlarge2"><%=catName %></span></a> &gt;
			<%=name %>
		</div>
	...
	<div class="detail_view_area table_display">
		...
		<div id="detail_view_content01" class="table_display">
			<div style="width:inherit">
				...
				<% if (S_ID.equals("")) { %>
				<div style="position:absolute;width:80px;top:283px;left:71px;">
					<form name="downloadForm" method="post" action="">
						<fieldset>
					  		<legend>DownLoad</legend>
					  		<a href="javascript:PageUtil.alertLogin('<%=objId %>');"><img src="<%=ROOT_DIR %>/images/sub_download.jpg" alt="DownLoad button image"></a>
						</fieldset>
					</form>
				</div>
				<% } else { %>
				<div style="position:absolute;width:80px;top:283px;left:71px;">
					<form name="downloadForm" method="post" action="">
						<fieldset>
					  		<legend>DownLoad</legend>
					  		<input type="hidden" name="userId" id="userId" value="<%=S_ID %>">
					  		<input type="hidden" name="packages" id="packages" value="<%=value %>">
					  		<a href="javascript:PageUtil.downloadProduct('<%=objId %>');"><img src="<%=ROOT_DIR %>/images/sub_download.jpg" alt="DownLoad button image"></a>
						</fieldset>
					</form>
				</div>
				<% } %>
